...
Image24BitModel::Image24BitModel(Shared* const sh, const uint64_t size) : 
  ...
  map{ /* StationaryMap : BitsOfContext, InputBits, Scale=64, Rate=16  */
    ...
    /*nSM1:72-82*/ {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74}, {sh,11,1,74},
