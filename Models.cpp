...
auto Models::lstmModelText() -> LstmModel& {
  static LstmModel* instance = LstmFactory::CreateLSTM(shared, 200, 2, 100, 0.06f); //warning: current pre-trained LSTM repository 'english.rnn' is using this structure, don't change these parameters
  return *instance;
}

auto Models::lstmModelGeneric() -> LstmModel& {
  static LstmModel* instance = LstmFactory::CreateLSTM(shared, 200, 2, 100, 0.06f);
  return *instance;
}

auto Models::lstmModelExe() -> LstmModel& {
  static LstmModel* instance = LstmFactory::CreateLSTM(shared, 200, 2, 100, 0.06f); //warning: current pre-trained LSTM repository 'x86_64.rnn' is using this structure, don't change these parameters
  return *instance;
}
