...
g++ -DNDEBUG -I../zlib/ -O3 -fno-fast-math -ffp-contract=off -flto=auto -funroll-loops -ftree-vectorize -s -static -fno-rtti -std=gnu++17 adler32.o crc32.o deflate.o gzlib.o inffast.o inflate.o inftrees.o trees.o zutil.o ../src/file/*.cpp ../src/filter/*.cpp ../src/model/*.cpp ../src/text/*.cpp ../src/lstm/*.cpp ../src/*.cpp -opaq8px
