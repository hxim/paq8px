...
static void printHelp() {
  printf("\n"
         ...
         "\n"
         "    -savelstm:text SNAPSHOTFILENAME\n"
         "    Saves the LSTM model's learned parameters to the specified file when compression finishes.\n"
         "    This snapshot is lossless. Only the model used for text block(s) will be saved.\n"
         "    It's not possible to save a snapshot from other block types. This is an experimental feature.\n"
         "\n"
         "    -loadstm:text SNAPSHOTFILENAME\n"
         "    Loads the LSTM model's learned parameters from the specified file (which was saved earlier\n"
         "    by the -savelstm:text option). The LSTM model used for text blocks will use this loaded snapshot to\n"
         "    bootstrap its predictions. If you use this option for compression, you must also use it during\n"
         "    decompression with the same snapshot file; otherwise, the original content cannot be recovered.\n"
         "\n"
         "    -v\n"
         ...
         "    Overrides detected SIMD instruction set for neural network operations (CM mixer and LSTM model)\n"
         "\n"
         "\n"
